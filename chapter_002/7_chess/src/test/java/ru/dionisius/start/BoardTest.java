...
public class BoardTest {
	...
	/**
	 * White pawn for tests X start coordinate.
	 */
	static final int X_WHITE_PAWN_START = 1;
	/**
	 * White pawn for tests Y start coordinate.
	 */
	...
	/**
	 * Tests if start cell afted move figure is empty and finish cell is occupied by this figure.
	 */
	@Test
