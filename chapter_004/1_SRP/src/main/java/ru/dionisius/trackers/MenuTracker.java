...
public class MenuTracker {
	 ...
	 */
	private class Addition extends BaseAction implements UserAction {
		/**
		 * Default constructor.
	 ...
	 */
	private class Subtraction extends BaseAction implements UserAction {
		/**
		 * Default constructor.
		 * @param name specified name of this class execute action.
		 */
	 ...
	 */
	private class Multiplication extends BaseAction implements UserAction {
		/**
		 * Default constructor.
		 * @param name specified name of this class execute action.
		 */
	 ...
	 */
	private class Division extends BaseAction implements UserAction {
		/**
		 * Default constructor.
		 * @param name specified name of this class execute action.
		 */
