...
INSERT INTO orders (name ,create_date, user_id, categorie_id, comment_id,
	state_id, files_id) VALUES ('Task from admin', current_timestamp, '1', '2', '1');
INSERT INTO orders (name ,create_date, user_id, categorie_id, comment_id,
	state_id, files_id) VALUES ('Bug from admin', current_timestamp, '1', '1', '3');
INSERT INTO orders (name ,create_date, user_id, categorie_id, comment_id,
	state_id, files_id) VALUES ('Task from seller', current_timestamp, '2', '2', '2');
INSERT INTO orders (name ,create_date, user_id, categorie_id, comment_id,
	state_id, files_id) VALUES ('Bug from buyer', current_timestamp, '5', '1', '4');
