...
public class SighinControllerTest {
    ...
    private static final String expectedURI = "/WEB-INF/ru.dionisius.ru.dionisius.data/LoginView.jsp";
    ...
    public void whenWrongLoginAndPasswordThenServletSetsExpectedAttributeToRequest() throws ServletException, IOException {
        ...
        when(request.getRequestDispatcher("/WEB-INF/ru.dionisius.ru.dionisius.data/LoginView.jsp")).thenReturn(dispatcher);
